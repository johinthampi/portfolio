...
const Home = () => {
  ...
  const handleResumeClick = () => {
    playClickSound();
    window.open('/Docs/Johinthampi.pdf', '_blank');
  };
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:t-8 xl:pb-24">
          ...
          >
            <motion.h1 
              ...
              className="h1 mb-6"
            >
              Hi I'm <br /> <span className="text-gray-400">Johin thampi</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              I am a <span className='text-red-600'>Full Stack Developer</span> based in 📍Ernakulam, Kerala.
            </motion.p>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
