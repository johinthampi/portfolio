                        ...
                        {certificates.map((cert, index) => (
                          <SwiperSlide key={index}>
                            ...
                            >
                              ...
                              />
                              <h4 className='text-2xl font-semibold text-blue-600'>{cert.title}</h4>
                              ...
                              <Link href={cert.link} target='_blank' className='inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-xs rounded hover:bg-accent-hover transition-colors'>
                                View Certificate
                              </Link>
                            </motion.div>
                          </SwiperSlide>
                          ...
                          <TooltipProvider delayDuration={100}>
                            <Tooltip>
                              <TooltipTrigger className='w-full h-[150px] bg-gray-800 bg-opacity-50 backdrop-blur-lg rounded-xl flex justify-center items-center group'>
                                <motion.div 
                                  className='text-6xl group-hover:text-blue-600 transition-all duration-300'
